...
const agendaDetails = {
    ...
    "agenda21": "<small>A keynote on the evolving B2C landscape where AI-driven personalization and \"instant gratification\" are the baselines. This session focuses on how the salesforce moves from being 'transactional vendors' to 'lifestyle architects'.</small>",
    "agenda22": "<small>A leadership panel featuring internal execs and key Managed Service Partners (MSPs). It highlights how our collaborative 'TechCo' ecosystem creates a competitive advantage for Converge.</small>",
    "agenda23": "Short Break",
    "agenda24": "<small>An inspirational session on the psychology of the 'Switch'. It reframes market saturation not as a hurdle, but as an opportunity to win over dissatisfied customers from legacy providers through superior tech value.</small>",
    ...
    "agenda29": "<small>Understanding the psychology of the entrepreneur. This session covers how to pivot from \"Business ROI\" to \"Personal Freedom and Time Saved.\" It addresses the specific fears of SME owners (risk, implementation time, and cash flow).</small>",
